"""
Suppression des tables anciennes après migration
Date: 3 Février 2026
"""
...
def drop_old_tables():
    ...
    print("=" * 60)
    print("SUPPRESSION DES TABLES ANCIENNES")
    print("=" * 60)
...
if __name__ == "__main__":
    print("\n⚠️  ATTENTION: Cette opération va supprimer définitivement les tables anciennes!")
    print("Assurez-vous que la migration a été effectuée avec succès.\n")
